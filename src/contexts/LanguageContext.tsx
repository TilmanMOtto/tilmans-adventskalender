...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'door.myReply': 'Meine Antwort (Tilman)',
    'messages.title': 'Meine Nachrichten',
    'messages.empty': 'Du hast noch keine Nachrichten',
    'messages.door': 'Tür',
    'messages.replyPlaceholder': 'Antwort schreiben...',
    ...
    'admin.userResponse': 'Benutzer-Antwort',
    'auth.login': 'Anmelden',
  ...
  en: {
    ...
    'door.myReply': 'My reply (Tilman)',
    'messages.title': 'My Messages',
    'messages.empty': "You don't have any messages yet",
    'messages.door': 'Door',
    ...
    'admin.userResponse': 'User Response',
    'auth.login': 'Login',
    'auth.signup': 'Sign Up',
    'auth.email': 'Email',
